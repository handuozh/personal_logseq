...
title: KP2D
type: Article
citekey: tangNEURALOUTLIERREJECTION2020
public: true
publication date: [[2020]]
proceeding: [[ICLR]]
authors: [[Jiexiong Tang]], [[Hanme Kim]], [[Vitor Guizilini]], [[Sudeep Pillai]]
tags: #zotero, #literature-notes, #reference, [[Keypoint]], [[Descriptor-Matching]], [[Keypoint-Extraction-and-Description]], [[Unsuperpoint]], [[Self-supervised]], [[Encoder-decoder]], [[Siamese Network]]
public: true
---

- Meta Data
  heading:: true
	- #title NEURAL OUTLIER REJECTION FOR SELF-SUPERVISED KEYPOINT LEARNING   #readdone
		- PDF Attachments
			- [Tang et al_2020_NEURAL OUTLIER REJECTION FOR SELF-SUPERVISED KEYPOINT LEARNING.pdf](zotero://open-pdf/library/items/DEAGWREL)
		- zotero items: [Local library](zotero://select/items/1_SK5U8F3F)
	- #code https://github.com/TRI-ML/KP2D
- Abstract
  heading:: true
	- The learning framework is based on [[Unsuperpoint]] in a [[Self-supervised]] fashion by receiving
		- source image $$ I_s $$
			-
			  $$ K(I_s)=\{p_s,f_s,s_s\} $$
		- target image $I_t$
	...
	- **KeyPointNet ** :: a keypoint-network architecture that is especially amenable to robust keypoint detection and description.
- [[Self-supervised]] Keypoint Learning
  heading:: true
	...
	- ![ms3yhslJzZPWxUNrfg3XSH9RbSgXkP3y-f9GvX2aejwqjwvRmlwAt8pU1OqGBPXb2lctrVDIlva8SzmsdIFY3YBzDFtMgXllswRgfY8lzbhLHgvxq54mP1cWg7BBu_NR.png](../assets/pages_KP2D_1617249925242_0.png)
