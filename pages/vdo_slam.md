...
### (2)+(7) =>
#### ^^(12)^^  $$\mathbf{e}_i({}^0 \mathbf{X}_k, {}^{I_k}\boldsymbol{\phi})={}^{I_{k-1}}\tilde{\mathbf{P}}_{k-1}^i+{}^{I_k}\boldsymbo{\phi}^i-\pi\left({}^0\mathbf{X}_k^{-1} \cdot {}^0\mathbf{m}_{k-1}^i\right)$$
