...
####
$$\mathbf{e}_i({}^0_{k-1} \mathbf{H}_k)\begin{bmatrix}=\{{}^{I_k}\tilde{\mathbf{P}}_k^i-\pi\left({}^0\mathbf{X}_k^{-1} \cdot {}^0 {}^0_{k-1} \mathbf{H}_k \mathbf{m}_{k-1}^i\right) \\
\{{}^{I_k}\tilde{\mathbf{P}}_k^i-\pi\left({}^0\mathbf{X}_k^{-1} \cdot {}^0 {}^0_{k-1} \mathbf{H}_k \mathbf{m}_{k-1}^i\right)$$
