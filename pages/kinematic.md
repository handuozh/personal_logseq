...
####
$$\mathbb{R}^{3\times 3} \rightarrow \mathbb{R}^{3\times 3}, \mathbf{A} \rightarrow e^{\mathbf{A}}, \mathbf{A}\in{\mathbb{R}^{3\times 3}}$$
...
#### ${}_B\bar{\mathbf{r}}_{OP}=\left[\right]^{\top}$, from point $O$ to point $P$ in frame $B$.
